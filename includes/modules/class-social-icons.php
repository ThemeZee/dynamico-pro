...
class Dynamico_Pro_Social_Icons {
	...
	static function get_social_svg( $icon = null ) {
		...
		$svg .= ' <use xlink:href="' . DYNAMICO_PRO_PLUGIN_URL . 'assets/icons/social-icons.svg#icon-' . esc_html( $icon ) . '"></use> ';
		$svg .= '</svg>';
	...
	static function register_nav_menus() {
		...
		register_nav_menus( array(
			'social-header' => esc_html__( 'Social Icons (Header)', 'dynamico-pro' ),
...
// Run Class.
add_action( 'init', array( 'Dynamico_Pro_Social_Icons', 'setup' ) );
