 ...
 * Footer Menu Class
 */
class Dynamico_Pro_Footer_Menu {
	...
	static function setup() {
		...
		add_action( 'dynamico_footer_menu', array( __CLASS__, 'display_footer_menu' ) );
	}
	...
	static function display_footer_menu() {
		...
		if ( has_nav_menu( 'footer' ) || has_nav_menu( 'social-footer' ) ) : ?>
			...
			if ( has_nav_menu( 'social-footer' ) ) {
				...
				Dynamico_Pro_Social_Icons::display_social_icons_menu( 'social-footer' );
	...
	static function register_footer_menu() {
		...
		register_nav_menu( 'footer', esc_html__( 'Footer Navigation', 'dynamico-pro' ) );
	}
}

// Run Class.
add_action( 'init', array( 'Dynamico_Pro_Footer_Menu', 'setup' ) );

// Register footer navigation in backend.
add_action( 'after_setup_theme', array( 'Dynamico_Pro_Footer_Menu', 'register_footer_menu' ), 30 );
